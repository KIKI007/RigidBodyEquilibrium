...
#ifndef TOPOLITE_EQUILIBRIUMFRICTIONLESSSOLVER_MOSEK_H
#define TOPOLITE_EQUILIBRIUMFRICTIONLESSSOLVER_MOSEK_H

#include "mosek.h"
#include "EquilibriumFrictionLessSolver.h"

template<int dim>
class EquilibriumFrictionLessSolver_Mosek: public EquilibriumFrictionLessSolver<dim> {
public:
...
public:
    EquilibriumFrictionLessSolver_Mosek(pContactGraph _graph) :
...
public:
    ...
    bool isEquilibrium_Variables(Vector3 gravity, shared_ptr<StaticData> &data);
